...
nx g @nx/angular:component ui/src/lib/button`),n()()(),e(159,"p",51),t(160," Carefully crafted with "),r(),e(161,"svg",52),i(162,"path",53),n()()()())},dependencies:[h],styles:[`
    ...
    `],encapsulation:2})}return a})();var k=(()=>{class a{title="mat.Eco";static \u0275fac=function(l){return new(l||a)};static \u0275cmp=m({type:a,selectors:[["app-root"]],standalone:!0,features:[s],decls:2,vars:0,template:function(l,z){l&1&&i(0,"app-nx-welcome")(1,"router-outlet")},dependencies:[w,v,x]})}return a})();var S=[];var y={providers:[u(),p({eventCoalescing:!0}),b(S)]};var M={providers:[f()]},E=c(y,M);var V=()=>g(k,E),J=V;export{J as a};
